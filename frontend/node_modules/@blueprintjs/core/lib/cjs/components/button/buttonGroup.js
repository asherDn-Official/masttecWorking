...
exports.ButtonGroup = React.forwardRef(function (props, ref) {
    var _a;
    var alignText = props.alignText, className = props.className, fill = props.fill, minimal = props.minimal, outlined = props.outlined, large = props.large, vertical = props.vertical, htmlProps = tslib_1.__rest(props, ["alignText", "className", "fill", "minimal", "outlined", "large", "vertical"]);
