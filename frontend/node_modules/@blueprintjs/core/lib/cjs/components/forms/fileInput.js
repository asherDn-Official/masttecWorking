...
var FileInput = function (props) {
    var _a, _b, _c;
    var buttonText = props.buttonText, className = props.className, disabled = props.disabled, fill = props.fill, _d = props.hasSelection, hasSelection = _d === void 0 ? false : _d, _e = props.inputProps, inputProps = _e === void 0 ? {} : _e, large = props.large, onInputChange = props.onInputChange, small = props.small, _f = props.text, text = _f === void 0 ? "Choose file..." : _f, htmlProps = tslib_1.__rest(props, ["buttonText", "className", "disabled", "fill", "hasSelection", "inputProps", "large", "onInputChange", "small", "text"]);
