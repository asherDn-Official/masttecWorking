...
exports.SegmentedControl = React.forwardRef(function (props, ref) {
    var _a;
    var className = props.className, defaultValue = props.defaultValue, fill = props.fill, inline = props.inline, intent = props.intent, large = props.large, onValueChange = props.onValueChange, options = props.options, _b = props.role, role = _b === void 0 ? "radiogroup" : _b, small = props.small, controlledValue = props.value, htmlProps = tslib_1.__rest(props, ["className", "defaultValue", "fill", "inline", "intent", "large", "onValueChange", "options", "role", "small", "value"]);
    var _c = React.useState(defaultValue), localValue = _c[0], setLocalValue = _c[1];
    ...
    return (React.createElement("div", tslib_1.__assign({}, (0, props_1.removeNonHTMLProps)(htmlProps), { role: role, onKeyDown: handleKeyDown, className: classes, ref: (0, common_1.mergeRefs)(ref, outerRef) }), options.map(function (option, index) {
        ...
        return (React.createElement(SegmentedControlOption, tslib_1.__assign({}, option, { intent: intent, isSelected: isSelected, key: option.value, large: large, onClick: handleOptionClick, small: small }, (role === "radiogroup"
            ? {
...
function SegmentedControlOption(_a) {
    ...
    return React.createElement(buttons_1.Button, tslib_1.__assign({}, buttonProps, { onClick: handleClick, minimal: !isSelected, text: label }));
}
