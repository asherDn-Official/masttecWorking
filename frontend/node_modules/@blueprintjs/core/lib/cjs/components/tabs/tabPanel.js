...
var TabPanel = /** @class */ (function (_super) {
    ...
    TabPanel.prototype.render = function () {
        ...
        var _b = (0, tabTitle_1.generateTabIds)(parentId, id), tabTitleId = _b.tabTitleId, tabPanelId = _b.tabPanelId;
        return (React.createElement("div", { "aria-labelledby": tabTitleId, "aria-hidden": !isSelected, className: (0, classnames_1.default)(common_1.Classes.TAB_PANEL, className), id: tabPanelId, role: "tabpanel" }, common_1.Utils.isFunction(panel) ? panel({ tabTitleId: tabTitleId, tabPanelId: tabPanelId }) : panel));
    };
    return TabPanel;
