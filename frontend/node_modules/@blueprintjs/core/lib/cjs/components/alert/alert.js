...
var Alert = /** @class */ (function (_super) {
    ...
    Alert.prototype.render = function () {
        ...
        return (React.createElement(dialog_1.Dialog, tslib_1.__assign({}, overlayProps, { role: "alertdialog", className: (0, classnames_1.default)(common_1.Classes.ALERT, className), canEscapeKeyClose: canEscapeKeyCancel, canOutsideClickClose: canOutsideClickCancel, onClose: this.handleCancel }),
