...
export const FileInput = (props) => {
    const { buttonText, className, disabled, fill, hasSelection = false, inputProps = {}, large, onInputChange, small, text = "Choose file...", ...htmlProps } = props;
    ...
    return (React.createElement("label", { ...htmlProps, className: rootClasses },
        React.createElement("input", { ...inputProps, onChange: handleInputChange, type: "file", disabled: disabled }),
