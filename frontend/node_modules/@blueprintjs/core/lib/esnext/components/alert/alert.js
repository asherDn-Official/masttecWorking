...
export class Alert extends AbstractPureComponent {
    ...
    render() {
        ...
        return (React.createElement(Dialog, { ...overlayProps, role: "alertdialog", className: classNames(Classes.ALERT, className), canEscapeKeyClose: canEscapeKeyCancel, canOutsideClickClose: canOutsideClickCancel, onClose: this.handleCancel },
