...
export class TabPanel extends AbstractPureComponent {
    render() {
        ...
        return (React.createElement("div", { "aria-labelledby": tabTitleId, "aria-hidden": !isSelected, className: classNames(Classes.TAB_PANEL, className), id: tabPanelId, role: "tabpanel" }, Utils.isFunction(panel) ? panel({ tabTitleId, tabPanelId }) : panel));
    }
}
