...
var Tabs = /** @class */ (function (_super) {
    ...
    function Tabs(props) {
        ...
        _this.renderTabPanel = function (tab) {
            ...
            return (React.createElement(TabPanel, __assign({}, tab.props, { key: id, className: classNames(className, panelClassName), parentId: _this.props.id, selectedTabId: _this.state.selectedTabId })));
        };
