...
var TabPanel = /** @class */ (function (_super) {
    ...
    TabPanel.prototype.render = function () {
        ...
        return (React.createElement("div", { "aria-labelledby": tabTitleId, "aria-hidden": !isSelected, className: classNames(Classes.TAB_PANEL, className), id: tabPanelId, role: "tabpanel" }, Utils.isFunction(panel) ? panel({ tabTitleId: tabTitleId, tabPanelId: tabPanelId }) : panel));
    };
    return TabPanel;
