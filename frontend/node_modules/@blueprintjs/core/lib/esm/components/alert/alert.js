...
var Alert = /** @class */ (function (_super) {
    ...
    Alert.prototype.render = function () {
        ...
        return (React.createElement(Dialog, __assign({}, overlayProps, { role: "alertdialog", className: classNames(Classes.ALERT, className), canEscapeKeyClose: canEscapeKeyCancel, canOutsideClickClose: canOutsideClickCancel, onClose: this.handleCancel }),
