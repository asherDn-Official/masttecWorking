...
export var SegmentedControl = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement("div", __assign({}, removeNonHTMLProps(htmlProps), { role: role, onKeyDown: handleKeyDown, className: classes, ref: mergeRefs(ref, outerRef) }), options.map(function (option, index) {
        ...
        return (React.createElement(SegmentedControlOption, __assign({}, option, { intent: intent, isSelected: isSelected, key: option.value, large: large, onClick: handleOptionClick, small: small }, (role === "radiogroup"
            ? {
...
function SegmentedControlOption(_a) {
    ...
    return React.createElement(Button, __assign({}, buttonProps, { onClick: handleClick, minimal: !isSelected, text: label }));
}
